...
const double lambda = 1000.0; // Plasma multiplicity // normally 10000
double gamma0; // Plasma mean gamma factor // normally 50
const double f0 = 0.6; // Polar Cap gap width // normally 0.5
const double R_em = 80.0; // Emission radius in star radii

...
const double B12 = 1.97;
const double Period = 0.25; // Rotation period in sec // normally 1.0
const double freqGHz = 1.41; // Radiation frequency in GHz // normally 1.0

double lambda = 1000.0; // Plasma multiplicity // normally 10000
double gamma0 = 100.0; // Plasma mean gamma factor // normally 50

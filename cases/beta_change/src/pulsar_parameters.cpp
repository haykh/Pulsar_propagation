...
const double B12 = 1.6;
const double Period = 0.23; // Rotation period in sec // normally 1.0
const double freqGHz = 1.4; // Radiation frequency in GHz // normally 1.0

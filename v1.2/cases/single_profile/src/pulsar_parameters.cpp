...
const double B12 = 0.01; // Surface B-field in 10^12 Gs
const double Period = 0.1; // Rotation period in sec
const double freqGHz = 1.0; // Radiation frequency in GHz
